"""
Sprint 20 Full Validation Test Runner Script.

Executes all 10 test modules (308+ test scenarios) and records exact metrics into data/sprint20_test_results.txt.
"""
...
if __name__ == "__main__":
    ...
    summary_file = "data/sprint20_test_results.txt"
    os.makedirs("data", exist_ok=True)
    with open(summary_file, "w") as f:
        f.write("=== NOC COPILOT SPRINT 20 FULL TEST SUITE SUMMARY ===\n")
