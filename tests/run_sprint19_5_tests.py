"""
Sprint 19.5 Full Validation Test Runner Script.

Executes all 9 test suites and records exact test counts, pass/fail/skip totals, and execution durations.
"""
...
if __name__ == "__main__":
    ...
    summary_file = "data/sprint19_5_test_results.txt"
    os.makedirs("data", exist_ok=True)
    with open(summary_file, "w") as f:
        f.write("=== NOC COPILOT SPRINT 19.5 FULL TEST SUITE SUMMARY ===\n")
